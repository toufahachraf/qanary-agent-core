...
# Pointing specifically to us-central1 and the stable 001 version to avoid 404 errors in other regions.
llm = ChatVertexAI(model_name="gemini-1.5-pro-001", temperature=0.1, location="us-central1")
